          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/calculator" className="btn-primary bg-white text-blue-700 hover:bg-gray-100 cursor-pointer">
                  Calculate Your Investment
                </Link>
                <Link to="/concepts" className="btn-outline border-white text-white hover:bg-blue-500 cursor-pointer">
      ...
      <section className="py-16 bg-blue-600 text-white text-center">
        <div className="container-custom">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link to="/markets" className="btn-outline border-white text-white hover:bg-blue-700 cursor-pointer">
