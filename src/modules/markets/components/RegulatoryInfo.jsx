  ...
  return (
    <div className="card">
      <div className="prose max-w-none">
        <p className="text-gray-700 mb-6">{regulatoryInfo.overview}</p>
        
        <div className="mb-8">
          <h3 className="text-xl font-bold mb-4">Foreign Investor Regulations</h3>
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <p className="text-gray-700">{regulatoryInfo.foreignInvestorRules}</p>
          </div>
          ...
          {regulatoryInfo.restrictions.length > 0 ? (
            ...
            <p className="text-gray-700 mb-4">No significant restrictions for foreign investors.</p>
          )}
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-700">{regulatoryInfo.taxes.propertyTax}</p>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold mb-2">Capital Gains</h4>
              <p className="text-gray-700">{regulatoryInfo.taxes.capitalGains}</p>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold mb-2">Rental Income</h4>
              <p className="text-gray-700">{regulatoryInfo.taxes.rentalIncome}</p>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              <h4 className="font-semibold mb-2">Other Taxes</h4>
              <p className="text-gray-700">{regulatoryInfo.taxes.other}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <ol className="list-decimal pl-6 mb-6">
            {regulatoryInfo.purchaseProcess.map((step, index) => (
              <li key={index} className="text-gray-700 mb-3">{step}</li>
            ))}
          </ol>
        ...
        <div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <p className="text-gray-700">{regulatoryInfo.tenantLaws.overview}</p>
          </div>
