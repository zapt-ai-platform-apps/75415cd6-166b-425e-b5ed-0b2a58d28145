      ...
      <div className="card mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-blue-50 p-4 rounded-lg text-center">
            <p className="text-gray-600 mb-1">Potential Property Value</p>
          ...
          <div className="bg-blue-50 p-4 rounded-lg text-center">
            <p className="text-gray-600 mb-1">Recommended Down Payment</p>
            <p className="text-3xl font-bold text-blue-700">
          ...
          <div className="bg-blue-50 p-4 rounded-lg text-center">
            <p className="text-gray-600 mb-1">Monthly Payment Capacity</p>
            <p className="text-3xl font-bold text-blue-700">
      ...
      <div className="card">
        ...
        {recommendations.locationAdvice && (
          <div className="mt-8 bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-gray-700">{recommendations.locationAdvice}</p>
          </div>
        )}
